...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/17 00:23:40 by kimkwanho         #+#    #+#             */
/*   Updated: 2021/02/25 20:04:20 by kimkwanho        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_cub_read_color(char *lin, int chr, int idx,
					t_cub3d *cub);
...
char				**ft_translate_map_init(char *str, char **map,
					t_cub3d *cub);
void				ft_player_set_start(t_cub3d *cub, char dir, int cur,
					int u);
...
void				ft_texture_side(t_cub3d *cub, t_ray *ray, t_lin *lin,
					double wlx);
