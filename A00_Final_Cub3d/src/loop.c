...
/*   Updated: 2021/02/24 09:14:46 by kimkwanho        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_loop_draw(t_cub3d *cub)
{
	...
	mlx_string_put(cub->mlx, cub->win, cub->wid - 65, 25, 0xffffff,
		ft_util_itoa(cub->pos->left_food));
	mlx_string_put(cub->mlx, cub->win, cub->wid - 40, 25, 0xffffff, "/15");
}
...
void				ft_loop_draw_string_put(t_cub3d *cub)
{
	...
	mlx_string_put(cub->mlx, cub->win, 25, 190, 0xffffff, "Width : ");
	mlx_string_put(cub->mlx, cub->win, 105, 190, 0xffffff,
		ft_util_itoa(cub->wid));
	mlx_string_put(cub->mlx, cub->win, 25, 210, 0xffffff, "Height: ");
	mlx_string_put(cub->mlx, cub->win, 105, 210, 0xffffff,
		ft_util_itoa(cub->hei));
}
