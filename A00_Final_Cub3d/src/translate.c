...
/*   Updated: 2021/02/19 23:47:29 by kimkwanho        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				**ft_translate_map(char *str, t_cub3d *cub)
{
	...
	cub->map->map = ft_translate_map_malloc(cub);
	cub->map->map = ft_translate_map_init(str, cub->map->map, cub);
	if (!ft_translate_map_check(cub, cub->map->map))
